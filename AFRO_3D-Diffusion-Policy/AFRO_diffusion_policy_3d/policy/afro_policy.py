...
from diffusion_policy_3d.model.vision.pointnet_extractor import VisEncoder, StaEncoder, IDMEncoder, FDMDecoder
# from diffusion_policy_3d.model.vision.pointnet_addition import  CPDM, CPDM_Light
...
class DP3(BasePolicy):
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        if self.obs_as_global_cond:
            ...
            vis_features = self.vis_encoder(this_nobs)
